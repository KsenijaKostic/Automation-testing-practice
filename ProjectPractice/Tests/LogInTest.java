...
public class LogInTest extends BasePage {
    ...
    public void VerifyThatUserCanNotLogInWithInvalidUsername() {
        ...
        /*wdwait.until(ExpectedConditions.visibilityOf(testLogInPage.getErrorMessage()));
        Assert.assertTrue(testLogInPage.getErrorMessage().isDisplayed());
        String expectedErrMesage = "Your username is invalid!"; //ovde nesto ne valja pa revidiraj sta je ovde i u test log in page
        Assert.assertEquals(testLogInPage.textErrorMessage(), expectedErrMesage);*/
    }
